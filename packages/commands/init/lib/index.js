...
const { Command, Package } = require('@moderate-cli/models');

const log = require('@moderate-cli/log');
const { spinnerStart, sleep, execAsync } = require('@moderate-cli/utils');
...
class InitCommand extends Command {
        ...
        if (await this.templateNpm.exists()) {
            ...
            if (fs.existsSync(rootFile)) {
                ...
                if (process.env.CLI_DEBUG) {
                    rootFile = "/Users/johnlee/workSpace/frontEnd/cli/template/moderate-admin"
                }
    ...
    async downloadTemplate() {
        ...
        const storeDir = path.resolve(userHome, '.moderate-cli', 'template', 'node_modules');
